...
const OtpVerification = ({ navigation }) => {
  ...
  return (
    <SafeAreaView className="flex-1 items-center">
      ...
      <Text className="text-[14px] mt-5">Please wait to receive OTP Verification Message</Text>
      <View className="my-10 mx-10">
        ...
        <TouchableOpacity onPress={() => onNavigate("OtpVerification")} className={`bg-[#007A72] mt-10 rounded-full p-4 items-center`}>
